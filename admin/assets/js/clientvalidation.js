function validateForm(event) {
    var client_name = document.forms["submit"]["client_name"].value.trim();
    var imageInput = document.forms["submit"]["image"];
    var description = document.forms["submit"]["description"].value.trim();
    var client_name_error = document.getElementById("client_name_error");
    ...
    if (client_name === '') {
      client_name_error.innerHTML = 'Please enter a client name.';
      isValid = false;
    }
